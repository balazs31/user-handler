export class Constants {
    ...
    public static VALIDATOR_MESSAGES = {
        ...
        USERNAME: {
            ...
            PATTERN: "Can only contain lowercase, uppercase letters, numbers and the \'_\'|'\-'\ symbols",
            TAKEN: "Username is already taken"
        },
        FIRST_NAME: {
            MIN_LENGTH: "Minimum 2 characters",
            PATTERN: "Can only contain lowercase, uppercase letters and the \'-\' symbol"
        },
        LAST_NAME: {
            MIN_LENGTH: "Minimum 2 characters",
            PATTERN: "Can only contain lowercase, uppercase letters and the \'-\' symbol"
        ...
        NEW_PASSWORD_1: {
            PATTERN: "Password must contain at least a symbol, an uppercase and a lowercase letter",
